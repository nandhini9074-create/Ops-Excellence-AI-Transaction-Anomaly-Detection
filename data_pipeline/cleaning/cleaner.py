...
class TransactionCleaner:
    def clean_batch(self, transactions: List[Dict[Any, Any]]) -> List[Dict[Any, Any]]:
        ...
        for tx in transactions:
            # Create a copy to avoid mutating input directly if not intended
            c_tx = dict(tx)
